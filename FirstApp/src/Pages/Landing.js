    ...
    <><div className='container container--landing'>
      <div className="landing-container">
        <div className="left-section">
          ...
          <button className="google_btn" onClick={handleEntrance}>Login with Google</button>
          <button className="email_btn" onClick={handleEntrance}>login by email address</button>
          <p className="terms">
    ...
    <div className='container container--landing'>
      <div className="discover-section">
        ...
        <div className="bottom-part">
          ...
          <button className="login-btn" onClick={handleEntrance}>Login</button>
        </div>
      </div>
    </div></>
  );
