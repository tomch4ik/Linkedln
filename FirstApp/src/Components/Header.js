    ...
    <header>
      ...
      {maximal ? (
        <>
          <div className="header_frame">
            <form role="search" className="header_input">
              <input name="header_search" type="search" placeholder="Search" />
              <img
        ...
        <div className='header_btn'>
            <button onClick={handleSignIn} className="btn_sing">Sign In</button>
            <button onClick={handleSignUp} className="btn_sing">Sign Up</button>
        </div>
      )}
    </header>
  );
